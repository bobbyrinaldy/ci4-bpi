...
<div class="row">
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        <form action="<?= route_to('facility.store') ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input name="name" type="text" class="form-control form-control-user" placeholder="Masukan nama fasilitas...">
